    ...
    let
      ...
      matchBlockStr =
        ...
        concatStringsSep "\n" (
          ...
          ++ optional (cf.forwardAgent != null) "  ForwardAgent ${yesNo cf.forwardAgent}"
          ...
          ++ optional (cf.compression != null) "  Compression ${yesNo cf.compression}"
          ++ optional (!cf.checkHostIP) "  CheckHostIP no"
          ++ optional (cf.proxyCommand != null) "  ProxyCommand ${cf.proxyCommand}"
          ++ optional (cf.proxyJump != null) "  ProxyJump ${cf.proxyJump}"
          ++ optional (cf.addKeysToAgent != null) "  AddKeysToAgent ${cf.addKeysToAgent}"
          ++ optional (cf.hashKnownHosts != null) "  HashKnownHosts ${yesNo cf.hashKnownHosts}"
    ...
    in
    {
      ...
      options.programs.ssh = {
        ...
        matchBlocks = mkOption {
          type = lib.ns.types.dagOf matchBlockModule;
          default = { };
          example = literalExpression ''
            {
              "john.example.com" = {
              ...
              foo = lib.ns.types.dag.entryBefore ["john.example.com"] {
                hostname = "example.com";
        ...
        lib.mkMerge [
          {
            ...
            file.home.".ssh/config".text =
              let
                sortedMatchBlocks = lib.ns.dag.topoSort (lib.removeAttrs cfg.matchBlocks [ "*" ]);
